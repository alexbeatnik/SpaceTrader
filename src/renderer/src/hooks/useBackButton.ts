 ...
 *
 * The gesture itself comes from `platform.onBackButton`, which is a no-op on
 * every host that has none — this hook never asks which one it is running in.
 *
